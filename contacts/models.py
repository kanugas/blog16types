...
class MyContactModel(models.Model):
    ...
    email = models.CharField(max_length=120,null=True,default=None, blank=True, verbose_name='Email')
    address = models.CharField(max_length=150, null=True,default=None, blank=True,verbose_name='Address')
